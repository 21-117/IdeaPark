...
namespace NovaSamples.AppleXRConcept.VisionOS
{
    ...
    public class PinchToClick : MonoBehaviour
    {
        ...
        [NonSerialized]
        private UIBlock pinchRoot = null;

        [NonSerialized]
        private float pinchStartTime = 0;

        [NonSerialized]
        private float pinchTriggerTime = 0;

        [NonSerialized]
        private float pinchEndTime = 0;

        [NonSerialized]
        private bool pinchWasActivated = false;

        [NonSerialized]
        private SingleHand pinchHand = default;

        [NonSerialized]
        private Vector3 pinchHandOriginRootSpace = Vector3.zero;
